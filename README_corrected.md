...
The project also includes two additional documentation files required by the subject:

- **USER_DOC.md**: explains how to use and administer the infrastructure, including how to start and stop it, access WordPress, manage credentials, and check the services.
- **DEV_DOC.md**: explains how to configure, build and run the project from scratch, as well as how containers, volumes and persistent data are managed.